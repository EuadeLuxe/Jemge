...
public class CullingTest extends JGame {
	...
	public void create() {
		...
		Jemge.manager.addResource("tile", new TextureResource(
				"assets/erdeundgras.jpg"));

		this.logger = new FPSLogger();

		for (int x = 0; x < 250; x++) {
			for (int y = 0; y < 250; y++) {
				Jemge.renderer2D.add(new JSprite(Jemge.manager
						.getTexture("tile"), x * 64, y * 64, 64, 64)
						.setStatic(true));
	...
	public static void main(String[] args) {
		...
		new JAppLWJGL(new CullingTest(), config); // finally create the lwjgl
													// application.
	}
}
