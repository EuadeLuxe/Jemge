...
/**
 * Box2d example: In the bottom of the screen is a platform. You can use a
...
public class LightsTest extends JGame {
	...
	public void create() {
		...
		this.mouse_light = new PointLight(Light.Quality.NICE, Color.WHITE, 500,
				20, 20);
	}

	/**
	 * Called when the {@link com.jemge.core.JGame} should render itself. Update
	 * stuff etc.
	 */
