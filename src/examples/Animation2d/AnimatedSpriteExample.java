...
public class AnimatedSpriteExample extends JGame {
    ...
    public static void main(String[] args) {
        ...
        new JAppLWJGL(new AnimatedSpriteExample(), config);   //finally create the lwjgl application.
    }
}
