...
public class SoundExample extends JGame {
	...
	public void create() {
		...
		Jemge.manager.addResource("ping", new AudioResource(
				"assets/test_sound.mp3"));
	}
	...
	public void render() {
		...
		if (Gdx.input.justTouched()) { // left click / touch screen?
			Jemge.audio.playSoundAtPosition(Jemge.manager.getSound("ping"),
					InputManager.getInputPosition()); // and create a new box
		}
	}
	...
	public static void main(String[] args) {
		...
		new JAppLWJGL(new SoundExample(), config); // finally create the lwjgl
													// application.
	}
}
